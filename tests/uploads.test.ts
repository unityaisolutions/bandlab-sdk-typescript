import fs from 'fs';
import type { ResponseLike } from 'bandlab-sdk/internal/to-file';
import { toFile } from 'bandlab-sdk/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('bandlab-sdk/core/uploads');
    await expect(
